  ...
  {:else if legacyData}
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
      ...
      <div class="lg:col-span-1 space-y-6">
        <div class="bg-white p-5 sm:p-6 rounded-xl border border-[#e5e0d8] shadow-2xs space-y-6 dark:bg-[#121827] dark:border-[#1e293b]">
          <div class="flex flex-col items-center text-center">
             ...
             <h2 class="font-serif text-lg sm:text-xl font-bold text-[#002d72] dark:text-slate-100 leading-tight">{legacyData.instructor_name}</h2>
             <p class="font-mono text-[10px] text-[#525f7f] font-semibold uppercase tracking-wider mt-1">Faculty Member</p>
          </div>
            ...
            {#each legacyData.preferred_slots as slot}
              <div class="flex items-center justify-between p-2.5 bg-[#faf8f5] rounded-lg border border-[#e5e0d8] dark:bg-[#0a0e1a] dark:border-[#1e293b]">
                 <div class="flex items-center space-x-2.5">
                   ...
                   <span class="text-xs font-semibold text-[#161e2e] dark:text-slate-300">{formatSlotTime(slot.hour)}</span>
                 </div>
        ...
        <div class="bg-white p-5 sm:p-6 rounded-xl border border-[#e5e0d8] shadow-2xs dark:bg-[#121827] dark:border-[#1e293b]">
          ...
          <div class="space-y-2.5 max-h-[480px] sm:max-h-[560px] overflow-y-auto pr-1 custom-scrollbar">
            {#each legacyData.history as item}
              <div class="flex items-start space-x-3 p-3 rounded-lg border border-[#e5e0d8] hover:border-[#c5a059] hover:bg-[#f3efe6]/50 transition-colors dark:border-[#1e293b] dark:hover:bg-slate-800/50">
